...
background-color:
 ...
 // while($result=mysql_fetch_array($row))
   // echo" <li><a href='coursecontent.php?a=$result[0]'>$result[1]</a></li>";
	...
	?>
     <li><a href="html_basic.php">HTML</a></li>
          <li><a href="css/home.php">CSS</a></li>
           <li><a href="js/home.php">JAVASCRIPT</a></li>
            <li><a href="php/home.php">PHP</a></li>
             <li><a href="sql/home.php">SQL</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active" style="color:#C00;"><a href="#"><h3 align="center">Courses </h3><span class="sr-only">(current)</span></a></li>
       <li style='text-align:center; font-size:150%;'><a href='html/home.php'>HTML</a></li>
       <li style='text-align:center; font-size:150%;'><a href='css/home.php'>CSS</a></li>
       <li style='text-align:center; font-size:150%;'><a href='js/home.php'>JAVASCRIPT</a></li>
       <li style='text-align:center; font-size:150%;'><a href='php/home.php'>PHP</a></li>
         <li style='text-align:center; font-size:150%;'><a href='sql/home.php'>SQL</a></li>
       <li style='text-align:center; font-size:150%;'><a href='bootstrap/home.php'>BOOTSTRAP</a></li>
       <li style='text-align:center; font-size:150%;'><a href='jquery/home.php'>JQUERY</a></li>
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="images/bootstrap.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Bootstrap</h4>
              <span class="text-muted">Bootstrap is a free and open-source front-end web framework for designing websites and web applications. It contains HTML- and CSS-based design templates for .....</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="images/css.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>CSS</h4>
              <span class="text-muted">CSS stands for Cascading Style Sheets
CSS describes how HTML elements are to be displayed on screen, paper, or in other media
CSS saves a lot of ....</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="images/HTML5Logo.jpg" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>HTML</h4>
              <span class="text-muted">HTML stands for Hyper Text Markup Language
HTML describes the structure of Web pages using markup ...</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="images/php.png" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Php</h4>
              <span class="text-muted">PHP (recursive acronym for PHP: Hypertext Preprocessor) is a widely-used open source general-purpose scripting language....</span>
 ...
 <hr>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" value="submit" name="submit">Sign in</button>
       <a href="sinup.php">For Signup Click Here</a>
    </div>
  </div>
</form> -->
<?php
...
include("db.php");
$row=mysql_query("Select *  from  registration where uname='$uname' and password='$password' ");
