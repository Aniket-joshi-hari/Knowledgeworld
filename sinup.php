...
{   echo " <li><a href='logout.php'>Logout</a></li>";
       ...
       <div class="item ">
        ...
        <div class="row">
         ...
         <h3>SignUp Form</h3>
          ...
          <form class="form-horizontal" action="sinup.php" method="POST" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="email" class="form-control" name="uname" id="inputEmail3" placeholder="Email">
    </div>
  </div>
  <div class="form-group">
...
if(isset($_POST["submit"]))
{
	...
	mysql_select_db("developer1");
	if(mysql_query("insert into registration  values('','$name','$uname','$password','$email','$gender') "))
	{
