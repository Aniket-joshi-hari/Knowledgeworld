...
{   echo " <li><a href='logout.php'>Logout</a></li>";
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li class="active" style='text-align:center; font-size:100%;'><a href='html_editors.php'>HTML Editors</a></li>
...
<li>We believe using a simple text editor is a good way to learn HTML.</li>

<li>Follow the four steps below to create your first web page with Notepad or TextEdit.
       ...
       <br>
<p style="font-size:130%; text-align:justify;">Open Finder > Applications > TextEdit</p>
<ul>
...
<li>Then under "Open and Save", check the box that says "Ignore rich text commands in HTML files".</li>
