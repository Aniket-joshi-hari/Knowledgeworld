...
{   echo " <li><a href='logout.php'>Logout</a></li>";
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li  class="active"style='text-align:center; font-size:100%;'><a href='html_basic.php'>HTML Basic</a></li>
       <li style='text-align:center; font-size:100%;'><a href='html_elements.php'>HTML Elements</a></li>
...
<div class="container-fluid"  style="background-color:white !important;">
                  <div class="alert-success"  style="padding:5px 5px 5px 5px; margin:10px 15px 15px 10px;">
<h2>HTML Basic Examples</h2>
<br>
<img src="../images/example14.png">
        ...
        <div class="container" style="color:white; padding:5px 5px 5px 5px;">
      ...
      <div class="col-md-10 " >
       <div class="alert-info" style="padding:5px 5px 5px 5px;">
      ...
      <h4><xmp> HTML paragraphs are defined with the<p>tag: </xmp></h4>
                  ...
                  <div class="alert-info" style="padding:5px 5px 5px 5px;">
                       ...
                       <h2>HTML Links</h2>
                            <br>
                              ...
                              <h3><xmp> HTML links are defined with the <a> tag:</xmp></h3>
                              
                              
                              
                   <h4>    <xmp>     <a href="https://www.w3schools.com">This is a link</a>  </xmp></h4>
                       
                        <br> <br>
                       
                   <h4>    The link's destination is specified in the href attribute. </h4>

 <h4>                        Attributes are used to provide additional information about HTML elements.</h4>
