    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li style='text-align:center; font-size:100%;'><a href='html_elements.php'>HTML Elements</a></li>
         <li  class="active" style='text-align:center; font-size:100%;'><a href='html_attributes.php'>HTML Attributes</a></li>
...
<br>
<hr>
<h4>Attributes provide additional information about HTML elements.</h4>
<hr>
<br>
...
<li>Attributes usually come in name/value pairs like: name="value"
        ...
        <ul>
<li><xmp>The language of the document can be declared in the <html> tag.</xmp></li>

<li><xmp>The language is declared with the lang attribute.</xmp></li>


<li><xmp>Declaring a language is important for accessibility applications (screen readers) and search engines:</xmp></li>
        ...
        <br>
         ...
         <li><xmp>The first two letters specify the language (en). If there is a dialect, use two more letters (US).
