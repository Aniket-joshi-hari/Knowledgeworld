...
//}
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li class="active" style='text-align:center; font-size:100%;'><a href='home.php'>HTML Home</a></li>
     ...
     <li style='text-align:center; font-size:100%;'><a href='html_editors.php'>HTML Editors</a></li>
       ...
       <li style='text-align:center; font-size:100%;'><a href='html_paragraph.php'>HTML Paragraph</a></li>
        ...
        <div class="col-sm-12 col-sm-offset-1 col-md-12 col-md-offset-1 " id="slide1">
        <div id="my-slider" class="carousel slide" data-ride="carousel" id="slide3">
       ...
       <div class="item ">
        ...
        <span class="sr-only">Next</span>     </a>
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header">HTML5 Tutorial</h3>
          <div class="container-fluid" style="background-color:white !important;">

                  <div class="alert-success" style="border:solid; padding:5px 5px 5px 10px; margin:10px 10px;">

<h4 style="font-size:200%;">With HTML you can create your own Web site.</h4>

<h4 style="font-size:200%;">This tutorial teaches you everything about HTML.</h4>

<h4 style="font-size:200%;">HTML is easy to learn - You will enjoy it.</h4>
