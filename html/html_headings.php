      ...
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav ">
         <li><a href="home.php">HTML</a></li>
          ...
          <!----  <li><a href="../sinup.php">SignUp</a></li> ---->s
...
{   echo " <li><a href='logout.php'>Logout</a></li>";
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li  class="active" style='text-align:center; font-size:100%;'><a href='html_headings.php'>HTML Headings</a></li>
       ...
       <div class="item ">
        ...
        <span class="sr-only">Next</span>     </a>
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="color:#005A31;">HTML Tutorial</h1>
<div class="container-fluid"  style="background-color:white !important;">
                  <div class="alert-success" style="padding:5px 5px 5px 5px; margin:10px 5px 5px 5px;">
<h2>HTML Headings</h2>
<br>
<hr>
<h4>Headings are important in HTML documents.</h4>
<hr>
<br>
<h3>HTML Headings</h3>
<ul>
<li><xmp>Headings are defined with the <h1> to <h6> tags.</xmp></li>

<li><xmp><h1> defines the most important heading. <h6> defines the least important heading.</xmp></li>
...
Note: Use HTML headings for headings only. Don't use headings to make text BIG or bold.
      ...
      <p> <xmp> The <hr> tag defines a thematic break in an HTML page, and is most often displayed as a horizontal rule.</xmp></p>
       <p> <xmp>The <hr> element is used to separate content (or define a change) in an HTML page:</xmp></p>
        <div class="container" ">
