	...
	*/ ?>
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li class="active" style='text-align:center; font-size:100%;'><a href='../js/home.php'>Javascript Home</a></li>
        <li  style='text-align:center; font-size:100%;'><a href='../js/js_intro.php'>Js Introduction</a></li>
       ...
       <div class="item ">
        ...
        <span class="sr-only">Next</span>     </a>
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="color:#005A31;">PHP Tutorial</h1>
