...
{   echo " <li><a href='logout.php'>Logout</a></li>";
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <li class="active" style='text-align:center; font-size:100%;'><a href='home.php'>CSS Home</a></li>
...
<ul>
<li>CSS is a language that describes the style of an HTML document.
</li>
<li>CSS describes how HTML elements should be displayed.
</li>
<li>This tutorial will teach you CSS from basic to advanced.
</li>
